...
def build_base_model(model_opt, vocabs, gpu, checkpoint=None, gpu_id=None):
    ...
    if checkpoint is not None:
        ...
        _strict = _os.environ.get("ONMT_STRICT_LOAD","0") == "1"
        model.load_state_dict(checkpoint['model'], strict=_strict)
        generator.load_state_dict(checkpoint['generator'], strict=_strict)
